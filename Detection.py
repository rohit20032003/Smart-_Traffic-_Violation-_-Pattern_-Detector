    ...
    def __init__(self, top=None):
        ...
        def sendChalan(event):
            ...
            try:
                ...
                self.yag.send(to='omkarjavali11@gmail.com', subject="Traffic Rule Challan", contents=message,
                              attachments=[data[0],'C:/Users/omkar/OneDrive/Desktop/Final Year Project/HELMET &NUMBER PLATE DETECTION & EXCEL STORE/qr/QR CODE.jpeg'])
                self.yag.close()
        ...
        def showOutput(event):
            try:
                ...
                if data[1]=="None":
                    self.cmbHelmetStatus.set('Helmet Not Found')
                    
                if data[1]=="True":
                    self.cmbHelmetStatus.set('Helmet Wearing')
                    
                if data[1]=="False":
                    self.cmbHelmetStatus.set('Helmet Not Wearing')
        ...
        def generate_excel():
            ...
            with open(filename, 'w', newline='') as file:
                ...
                writer.writerow(['Helmet Status', 'LP Status', 'No of passengers'])
                ...
                for file in listFiles:
                    try:
                        ...
                        if data[1] == "None":
                            helmet_status = "Helmet Not Found"
                        elif data[1] == "True":
                            helmet_status = "Helmet Wearing"
                        elif data[1] == "False":
                            helmet_status = "Helmet Not Wearing"
                        else:
                            helmet_status = ""
                        ...
                        # Write row to file
                        writer.writerow([helmet_status, lp_status, num_passengers])
        ...
        self.cmbHelmetStatus['values'] = ['Helmet Wearing','Helmet Not Wearing','Helmet Not Found','Triple Driving','Overspeeding','Red Light Jumping']
